  ...
  return (
      <>
        <Head>
          ...
          <meta name="description" content="Consulta las calificaciones y opiniones de profesores de diversas materias." />
            ...
            <div className="max-w-7xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div className="p-8 bg-gray-100 rounded-xl shadow-lg">
                  <h3 className="text-2xl font-semibold mb-4">Opiniones Reales</h3>
                  <p>Lee comentarios de estudiantes que ya han tomado clases con los profesores. Opiniones verídicas y sin censura.</p>
                </div>
                <div className="p-8 bg-gray-100 rounded-xl shadow-lg">
                  <h3 className="text-2xl font-semibold mb-4">Mejores Decisiones</h3>
                  <p>Tomar decisiones informadas sobre qué profesores tomar. ¡Tu tiempo es importante!</p>
                </div>
              </div>
            </div>
          </section>
