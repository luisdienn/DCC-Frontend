          ...
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center">
              <img
                ...
                className="h-6 mr-2"
              />
              <span className="text-xl font-semibold text-[#00479b] dark:text-[#e4e4e6]">
                Nombre
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-6">
              <Link
                href="/inicio"
                className="text-[#00479b] dark:text-[#e4e4e6] hover:text-[#006aea] transition"
              >
                Inicio
              </Link>
                  ...
                  <div className="relative" ref={menuRefDesktop}>
                    ...
                    {isMenuOpenDesktop && (
                      <div className="absolute right-0 mt-2 w-56 bg-[#fdfefe] dark:bg-[#00479b] rounded-lg shadow-lg overflow-hidden">
                        <Link
                          href="/ajustes"
                          className="block px-6 py-3 text-[#00479b] dark:text-[#e4e4e6] hover:bg-[#e4e4e6] dark:hover:bg-[#006aea] flex items-center"
                        >
                ...
                <>
                  ...
                  {isMenuOpenMobile && (
                    <div className="absolute right-0 mt-4 w-48 bg-white dark:bg-[#00479b] rounded-lg shadow-lg overflow-hidden">
                      <Link href="/ajustes" className="block px-4 py-2 text-[#006aea] dark:text-white hover:bg-gray-100 dark:hover:bg-[#006aea] flex items-center">
                        <FontAwesomeIcon icon={faCog} className="mr-2" /> Ajustes
                      </Link>
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-white dark:bg-[#00479b] shadow-md border-t">
        {isAuthenticated ? (
          <div className="flex justify-around py-3">
            <Link href="/inicio" className="flex flex-col items-center dark: text-gray-400">
              <FontAwesomeIcon icon={faHome} className="w-6 h-6" />
              <span className="text-sm">Inicio</span>
            </Link>
            <Link href="/profesores" className="flex flex-col items-center text-[#006aea] dark:text-white">
              <FontAwesomeIcon icon={faUser} className="w-6 h-6" />
              <span className="text-sm">Profesores</span>
            </Link>
            <Link href="/foro" className="flex flex-col items-center text-[#006aea] dark:text-white">
          ...
          <div className="flex justify-center py-3">
            <Link href="/inicio" className="flex flex-col items-center text-[#006aea]">
              <FontAwesomeIcon icon={faHome} className="w-6 h-6" />
              <span className="text-sm">Inicio</span>
            </Link>
          </div>
