...
const MateriaAdmin = () => {
  ...
  const handleEdit = async (id: string) => {
    try {
      ...
      setMateria(formattedData);
      console.log("Materia seleccionado:", formattedData);
    } catch (err) {
  ...
  return (
    <main className=" items-center min-h-screen w-full bg-gray-100">
      <div className="px-4 min-h-screen">
        <section className="relative w-full h-[50vh] p-4 bg-gradient-to-r from-blue-300 to-indigo-500">
        ...
        <div className="max-w-10xl w-full justify-center text-center mx-auto p-6 bg-white shadow-lg rounded-lg overflow-hidden mt-6">
          {isLoading ? (
